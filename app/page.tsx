      ...
      <section id="interactive-demo" className="py-16 px-4 md:px-8 max-w-6xl mx-auto">
        <div className="bg-card-bg border-2 border-panel-border rounded-3xl p-6 md:p-8 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2.5">
            {demoSeats.map((s) => {
              let color = "bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-500/20";
              let label = "Free";
              if (s.status === "full_day") {
                color = "bg-rose-500/15 text-rose-700 dark:text-rose-400 border border-rose-500/30";
                label = "Full";
                ...
                color = "bg-purple-500/15 text-purple-700 dark:text-purple-300 border border-purple-500/40";
                label = "2x Shift";
              } else if (s.status === "due") {
                color = "bg-blue-500/15 text-blue-700 dark:text-blue-400 border border-blue-500/40";
                label = "Due";
              }
