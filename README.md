...
A premium, modern web application designed to replace manual register logs and Excel sheets for **The Target Library** (Dehradun). Built with Next.js, Tailwind CSS v4, and Supabase, it features an elegant, Apple-inspired interface, support for up to 297 seats, live seat booking states, custom passes, and automated WhatsApp delivery.
...
1.  **Cinema-Style Seat Map (`/`)**
    *   Interactive grid layout showing **297 seats** with real-time status.
...
2. Run the migration to define tables, setup constraint rules (supporting 297 seats), and seed initial seat maps.
